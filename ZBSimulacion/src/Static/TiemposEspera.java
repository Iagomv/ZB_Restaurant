...
public class TiemposEspera {
    ...
    // CAMARERO
    public static final int tiempoTomarPedido = 1;
    public static final int tiempoLlevarBebida = 1;
    public static final int tiempoLlevarPlato = 1;
    public static final int tiempoCobrarPedido = 1;
    ...
    // SOMMELIER
    public static final int tiempoServirVino = 1;
