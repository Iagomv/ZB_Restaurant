...
public class PanelBebidas extends JPanel {
    ...
    public PanelBebidas() {
        ...
        // Display beverages and initialize the table
        mostrarBebidas();
    }

    public void mostrarBebidas() {
        try {
            // Get beverages from the controller
            ...
            // Populate the table model with beverages
            for (Bebida bebida : bebidas) {
                Object[] fila = { bebida.getNombre(), bebida.getTipo(), bebida.getPrecio(), bebida.getStock(), "Editar", "Eliminar"};
                modeloTabla.addRow(fila);
            }

            // Add a row for "Agregar"
            modeloTabla.addRow(new Object[] { "", "", "", "", "Agregar", "" });

            // Assign the model to the table
            table = new JTable(modeloTabla);

            // Add a listener to detect clicks on the "Acción" column
